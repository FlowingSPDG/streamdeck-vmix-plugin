...
async function connected(jsn) {
	...
	$SD.on(
		"com.acme.vMixPlugin.action.willAppear",
		jsonObj => action.onWillAppear(jsonObj)
	);
	$SD.on(
		"com.acme.vMixPlugin.action.keyUp",
		jsonObj => action.onKeyUp(jsonObj)
	);
	$SD.on(
		"com.acme.vMixPlugin.action.sendToPlugin",
		jsonObj => action.onSendToPlugin(jsonObj)
	);
	$SD.on(
		"com.acme.vMixPlugin.action.didReceiveSettings",
