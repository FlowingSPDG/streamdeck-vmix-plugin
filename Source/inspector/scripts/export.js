		...
		function (response) {
			...
			file.on("finish", function () {
				file.close(function () {
					...
					try {
						fs.removeSync(
							`./Release/com.acme.vMix-Plugin.streamDeckPlugin`
						);
						let distributionCommand = `${currentPlatform.distributionToolFilename} -b -i ./build/com.acme.vMixPlugin.sdPlugin -o ./Release`;
						if (os.platform() !== "win32") {
